  ...
  return (
    <section className="relative py-20 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none select-none" aria-hidden>
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary-subtle rounded-full blur-3xl opacity-50" />
        <div className="absolute top-10 right-1/4 w-80 h-80 bg-violet-100 dark:bg-violet-900/20 rounded-full blur-3xl opacity-50" />
      </div>

      <div className="relative max-w-3xl mx-auto text-center px-4">
        <div className="inline-flex items-center gap-2 bg-card border border-border rounded-full px-4 py-1.5 text-sm text-fg-muted font-medium mb-8 shadow-soft">
